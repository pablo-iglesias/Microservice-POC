...
public class ApiController extends Controller {
    ...
    /**
     * Creates and returns final HttpResponse object, used only for those
     * responses that deliver actual content, handles content negotiation
     * 
     * @param request
     * @param httpCode
     * @param message
    ...
    /**
     * Handler for Api requests, diverts requests to appropriate method of the
     * controller
     * 
     * @param request
     * @return
     ...
     * @throws Exception
     */
    private static HttpResponse PUT(HttpRequest request, Integer authUserId, Integer refUserId, String body)
            throws Exception {
        ...
        try {
            ...
            switch (result) {
                ...
                case UsecaseUpdateExistingUser.RESULT_USER_DOES_NOT_EXIST:
                    return respond(request, HttpURLConnection.HTTP_NOT_FOUND,
                            new ApiResponseError("User with this id does not exist"));
